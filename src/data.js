...
export default function levels (level) {
    if (level === 1){
      ...
      return [
        ...
        {key: nanoid(), value: "card six", isClicked: false, img: require('./card-img/4_of_clubs.png')},
        {key: nanoid(), value: "card seven", isClicked: false, img: require('./card-img/4_of_hearts.png')},
        {key: nanoid(), value: "card eight", isClicked: false, img: require('./card-img/4_of_spades.png')},
      ]
    } else if (level === 3) {
      return [
        {key: nanoid(), value: "card one", isClicked: false, img: require('./card-img/2_of_diamonds.png')},
        ...
        return [
            ...
            {key: nanoid(), value: "card fifteen", isClicked: false, img: require('./card-img/queen_of_spades.png')},
        ...
        return [
          ...
          {key: nanoid(), value: "card sixteen", isClicked: false, img: require('./card-img/queen_of_clubs.png')},
            ...
            {key: nanoid(), value: "card fifteen", isClicked: false, img: require('./card-img/king_of_spades.png')},
